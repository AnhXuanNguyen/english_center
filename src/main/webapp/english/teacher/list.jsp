        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <a href="/TeacherServlet?action=create&id=${ministryid}" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>Add New User</span></a>
                    </div>
                </div>
            </div>
...
<c:forEach items="${teachers}" var="teacher">
                <tr>
                    ...
                    <td>
                        <a href="/TeacherServlet?action=edit&id=${teacher.id}&mid=${ministryid}" class="settings" title="Settings" data-toggle="tooltip"><i class="material-icons">&#xE8B8;</i></a>
                        <a href="/TeacherServlet?action=drop&id=${teacher.id}&mid=${ministryid}" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE5C9;</i></a>
                    </td>
                </tr>
</c:forEach>
<%--                <tr>--%>
