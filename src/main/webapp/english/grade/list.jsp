...
<body>
<div class="container">
    <h3 style="margin-left: 40px"><a style="color: yellow" href="/GradeServlet?action=create&id=${ministryid}">THÊM LỚP</a></h3>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body text-center">
                    <h2 align="center" class="card-title m-b-0">Danh sách Lớp</h2>
                </div>
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th scope="col">List Học viên</th>
                            <th scope="col">Nhập ký</th>
                        </tr>
                        </thead>
                        ...
                        <c:forEach items="${grades}" var="g">
                            <tr>
                                ...
                                <td><a href="">Chi tiết</a></td>
                                <td><a href="/GradeServlet?action=edit&id=${g.id}&mid=${ministryid}">Sửa</a></td>
                                <td><a href="/GradeServlet?action=drop&id=${g.id}&mid=${ministryid}">Xóa</a></td>
                            </tr>
                        </c:forEach>
