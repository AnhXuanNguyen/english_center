...
<div id="form">
    ...
    <form id="waterform" method="post">
        ...
        <div class="formgroup" id="name-form">
            ...
            <input value="${grade.name}" type="text" id="name" name="newname" />
        </div>

        <div class="formgroup" id="name-form">
            <label for="name-teacher">Giảng viên phụ trách*</label>
            <!--      <input value="${grade.name}" type="text" id="name" name="newname" />-->
            <select name="teacher">
                <c:forEach items="${teachers}" var="t">
                    <option id="name-teacher" value="${t.id}">${t.name}</option>
                </c:forEach>
            </select>
        </div>

        <div class="formgroup" id="name-form">
            <label for="cou">Môn học*</label>
            <!--      <input value="${grade.name}" type="text" id="name" name="newname" />-->
            <select name="course">
                <c:forEach items="${courses}" var="c">
                    <option id="cou" value="${c.id}">${c.name}</option>
                </c:forEach>
            </select>
        </div>
